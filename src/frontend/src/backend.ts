...
export class Backend implements backendInterface {
    ...
    async addRoutine(arg0: string, arg1: string, arg2: string): Promise<RoutineId> {
        if (this.processError) {
            try {
                const result = await this.actor.addRoutine(arg0, arg1, arg2);
                return result;
            } catch (e) {
                this.processError(e);
    ...
    async editRoutine(arg0: RoutineId, arg1: string, arg2: string, arg3: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.editRoutine(arg0, arg1, arg2, arg3);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getRoutine(arg0: RoutineId): Promise<Routine> {
        if (this.processError) {
            try {
    ...
    async markRoutineCompleted(arg0: RoutineId): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.markRoutineCompleted(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
